...
export const Route = createFileRoute("/_authenticated/console/api-keys")({
  head: () => ({
    meta: [{ title: "API keys — eterfaceID" }, { name: "robots", content: "noindex" }],
  }),
...
function ApiKeysPage() {
  ...
  return (
    <ConsoleShell>
      <h1 className="font-display text-3xl font-bold tracking-tight">API Keys</h1>
      <p className="mt-2 max-w-2xl text-sm text-muted-foreground">
        Secrets are shown once. Sandbox and Live credentials are completely separate — a test key cannot reach
        production data.
      </p>
          ...
          {canManage ? (
            ...
            >
              <input
                ...
                placeholder='Name key, e.g. "ABC Development"'
                maxLength={60}
